...
: ${AMENT_CURRENT_PREFIX:="/root/map2_navigation/install/map2_navigation"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/map2_navigation/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/map2_navigation/environment/path.sh"
